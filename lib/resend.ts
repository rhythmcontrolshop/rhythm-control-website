...
export async function sendWelcomeEmail({
  ...
  const bodyHtml = `
    ...
    <div style="text-align: center; margin: 24px 0;">
      <a href="${process.env.NEXT_PUBLIC_SITE_URL || 'https://rhythmcontrolbarcelona.com'}/cuenta"
         style="background: #F0E040; color: #000000; padding: 14px 32px; text-decoration: none; font-weight: bold; font-size: 13px; letter-spacing: 0.06em; display: inline-block;">
        IR A MI CUENTA
      </a>
    </div>
...
export async function sendInvoiceEmail({
  ...
  const bodyHtml = `
    ...
    <div style="text-align: center; margin: 24px 0;">
      <a href="${process.env.NEXT_PUBLIC_SITE_URL || 'https://rhythmcontrolbarcelona.com'}/cuenta/pedidos"
         style="background: #F0E040; color: #000000; padding: 14px 32px; text-decoration: none; font-weight: bold; font-size: 13px; letter-spacing: 0.06em; display: inline-block;">
        VER MIS PEDIDOS
      </a>
    </div>
